...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var kirbyImage: MonsterIMG!
    ...
    override func viewDidLoad() {
        ...
        fruitImage.dropTarget = kirbyImage
        candyImage.dropTarget = kirbyImage
        oneupImage.dropTarget = kirbyImage
